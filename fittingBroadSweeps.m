...
% limit the range around each Q, then make a doublet fit
            ...
            [paramDoublet, resnorm] = performDoubletFit(xDataDoublet, yDataDoublet, centerWL, doubletWidth, {});

            if resnorm == -1
                fitType{paramIndex} = 'singlet';
            else
                params(:, paramIndex) = paramDoublet(1:3);
                params(:, paramIndex+1) = paramDoublet(4:6);
